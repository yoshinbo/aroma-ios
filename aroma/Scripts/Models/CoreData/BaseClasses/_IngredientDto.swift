...
// Make changes to IngredientDto.swift instead.

import CoreData

enum IngredientDtoAttributes: String {
...
@objc
class _IngredientDto: NSManagedObject {
    ...
    convenience init(managedObjectContext: NSManagedObjectContext!) {
        let entity = _IngredientDto.entity(managedObjectContext)
